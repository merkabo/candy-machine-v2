<script lang="ts">
  ...
  const TITLE = "USTURPUNKS P COLLECTION";
  const DESCRTIPTION = "Collection of 10.000 uniquely generated punks based on Ustur faction robots in Star Atlas Metaverse. NFT ownership equals exclusive membership equals discounts on in game club events and perks.";
  const HEADER_TITLE = "";
  const HEADER_LINK = "";
